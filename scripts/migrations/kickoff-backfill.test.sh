...
insert into gw_dm_events (id, home_id, away_id, kickoff) values
  ('ko_utc_ms',   'h','a','2026-10-18T00:00:00.000Z'),
  ('ko_utc_odd',  'h','a','2026-11-07T22:59:59.999Z'),
  ('ko_pg',       'h','a','2026-12-26 14:00:00+00'),
  ('ko_pg_ms',    'h','a','2026-12-30 18:44:59.999+00'),
  ('ko_dateonly', 'h','a','2027-03-20'),
  ('ko_zl_gmt',   'h','a','2026-12-26T14:00'),
  ('ko_zl_bst',   'h','a','2026-09-19T20:00'),
  ('ko_empty',    'h','a',''),
  ('ko_null',     'h','a',null);
SQL
...
FAILED=0
check ko_utc_ms   '2026-10-18 00:00:00+00'
check ko_utc_odd  '2026-11-07 22:59:59.999+00'
check ko_pg       '2026-12-26 14:00:00+00'
check ko_pg_ms    '2026-12-30 18:44:59.999+00'
check ko_dateonly '2027-03-20 00:00:00+00'
check ko_zl_gmt   '2026-12-26 14:00:00+00'
check ko_zl_bst   '2026-09-19 19:00:00+00'
check ko_empty    '<null>'
check ko_null     '<null>'
...
docker exec "$CONTAINER" psql -U postgres -v ON_ERROR_STOP=1 -qc \
  "insert into gw_dm_events (id, home_id, away_id, kickoff) values ('ko_bad','h','a','not a date');" >/dev/null
